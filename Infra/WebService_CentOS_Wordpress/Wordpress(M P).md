...
![Untitled](Wordpress(M%20P)/Untitled.png)
...
1. Rocky-server-gui 파일을 사용하여 구성한다. 
    1. 네트워크 : NAT
        ...
        ![Untitled](Wordpress(M%20P)/Untitled%201.png)
    ...
    3. 네트워크 셋팅 
        ...
        ![Untitled](Wordpress(M%20P)/Untitled%202.png)
...
1. **# vim /etc/named.conf 파일 수정 : DNS 서버환경 셋팅**
    ...
    ![Untitled](Wordpress(M%20P)/Untitled%203.png)
...
2. vim dns.test.example.com.zone
    ...
    ![Untitled](Wordpress(M%20P)/Untitled%204.png)
...
4. 파일 권한 변경하기
    ...
    ![Untitled](Wordpress(M%20P)/Untitled%205.png)
    ...
    ![Untitled](Wordpress(M%20P)/Untitled%206.png)
...
![Untitled](Wordpress(M%20P)/Untitled%207.png)
...
![Untitled](Wordpress(M%20P)/Untitled%208.png)
...
1. 기존 zone 파일 복사 해서 생성해줍니다.
    ...
    **전달영역설정** 
    ...
    ![Untitled](Wordpress(M%20P)/Untitled%209.png)
...
![Untitled](Wordpress(M%20P)/Untitled%2010.png)
...
1. /etc/httpd/conf/httpd.conf 해당 파일로 들어가서 추가 수정해준다. 
    ...
    ![Untitled](Wordpress(M%20P)/Untitled%2011.png)
    ...
    ![Untitled](Wordpress(M%20P)/Untitled%2012.png)
...
![Untitled](Wordpress(M%20P)/Untitled%2018.png)
...
![Untitled](Wordpress(M%20P)/Untitled%2019.png)
...
![Untitled](Wordpress(M%20P)/Untitled%2020.png)
...
- 확인할 버전 목록
    - httpd : web server
        ...
        ![Untitled](Wordpress(M%20P)/Untitled%2021.png)
        
    - mariaDB : DB server
    - php 버전 확인  : web server
        
        ![Untitled](Wordpress(M%20P)/Untitled%2022.png)
        
    - DB 버전확인 : DBserver
        
        ![Untitled](Wordpress(M%20P)/Untitled%2023.png)
...
- 해당 파일 167~169 번째 위치한 곳 뒤쪽에 index.php를 추가하여줍니다.
    ...
    ![Untitled](Wordpress(M%20P)/Untitled%2024.png)
    
- addtype을 추가해 줍니다.
    
    ![Untitled](Wordpress(M%20P)/Untitled%2025.png)
    
- /etc/php-fpm.d/www.conf 에 가서 설정을 해줍니다.  wq로 저장
    
    ESC ⇒ /(슬래쉬) ⇒ listen.acl 검색 ⇒ Enter
    
    ![Untitled](Wordpress(M%20P)/Untitled%2026.png)
...
![Untitled](Wordpress(M%20P)/Untitled%2027.png)
...
- php  적용을 확인합니다.
    ...
    ![Untitled](Wordpress(M%20P)/Untitled%2030.png)
...
- /var/www/html/wordpress/ 디렉토리 내부, wp-config-smaple.php를 복제 하여 wp-config.php를 생성한다.
    ...
    ![Untitled](Wordpress(M%20P)/Untitled%2031.png)
    ...
    ![Untitled](Wordpress(M%20P)/Untitled%2032.png)
...
![Untitled](Wordpress(M%20P)/Untitled%2033.png)

### 5.3.4 Wordpress 로그인

![Untitled](Wordpress(M%20P)/Untitled%2034.png)

![Untitled](Wordpress(M%20P)/Untitled%2035.png)
